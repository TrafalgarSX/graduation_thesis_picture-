'''
Author: guo yawen
Date: 2021-05-17 23:16:02
LastEditTime: 2021-05-17 23:34:36
LastEditors: guo yawen
Description: 
FilePath: \Thesis\lastDeleteLatency.py
TrafalgarSX
'''
...
# 统计数据
path_heigth = [1.084, 1.180, 1.196]
cached_heigth = [0.899, 0.979, 0.999]
...
plt.title('path和CEPH在LF=0.6下的删除延迟(后100万数据)')

plt.savefig('./picture/lastDeleteLatency0.6.jpg')
plt.show()
