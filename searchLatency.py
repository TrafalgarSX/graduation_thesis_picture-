'''
Author: guo yawen
Date: 2021-05-16 19:10:28
LastEditTime: 2021-05-16 23:34:18
LastEditors: guo yawen
Description: 
FilePath: \Thesis\searchLatency.py
TrafalgarSX
'''
...
# 统计数据
path_heigth = [0.812, 0.863, 0.913]
cached_heigth = [0.744, 0.793, 0.833]
...
plt.title('path和CEPH在LF=0.6下的搜索延迟')

plt.savefig('./picture/searchLatency0.6.jpg')
plt.show()
