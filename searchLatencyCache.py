'''
Author: guo yawen
Date: 2021-05-17 23:02:25
LastEditTime: 2021-05-17 23:08:57
LastEditors: guo yawen
Description: 
FilePath: \Thesis\searchLatencyCache.py
TrafalgarSX
'''
...
cached_heigthL3 = [1.550, 1.691, 1.700]
...
plt.title('CEPH在LF=0.8下保留两层和三层的搜索延迟比较')

plt.savefig('./picture/searchLatencyCache.jpg')
plt.show()
