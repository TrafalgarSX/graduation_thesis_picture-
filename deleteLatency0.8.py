'''
Author: guo yawen
Date: 2021-05-16 18:58:06
LastEditTime: 2021-05-17 22:43:04
LastEditors: guo yawen
Description: 
FilePath: \Thesis\deleteLatency0.8.py
TrafalgarSX
'''
...
# 统计数据
path_heigth = [1.015, 1.092, 1.158]
cached_heigth = [0.853, 0.921, 0.983]
...
plt.title('path和CEPH在LF=0.8下的删除延迟')

plt.savefig('./picture/deletetLatency0.8.jpg')
plt.show()
